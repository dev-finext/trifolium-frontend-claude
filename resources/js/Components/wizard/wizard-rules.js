...
export const VOLUME_RULES = {
    tincture: { unit: 'ml', options: [50, 100, 125, 200, 250, 300, 500, 1000], allowOther: true, min: 50, step: 1 },
    decoction: { unit: 'ml', options: [100, 200, 300, 400, 500, 600], allowOther: true, min: 100, step: 100 },
    capsule: { unit: 'קפסולות', options: [100, 200, 300, 400, 500], allowOther: true, min: 100, step: 100 },
    powder: { unit: 'גרם', options: [100, 150, 200], allowOther: true, min: 100 },
    tea: { unit: 'גרם', options: [100, 150, 200], allowOther: true, min: 100 },
    ...
    ioil: { unit: 'מ״ל', options: [50, 100, 125, 200, 250, 300, 500, 1000], allowOther: true, min: 50, step: 1 },
};
...
export const DOSE_RULES = {
    tincture:  { units: ['drops', 'ml'],    default: { qty: 20,  unit: 'drops',    perDay: 3 } },
    decoction: { units: ['ml', 'cups'],     default: { qty: 200, unit: 'ml',       perDay: 2 } },
    capsule:   { units: ['capsules'],       default: { qty: 2,   unit: 'capsules', perDay: 2 } },
    powder:    { units: ['spoons', 'grams'], default: { qty: 1,  unit: 'spoons',   perDay: 2 } },
    tea:       { units: ['cups', 'spoons', 'grams'], default: { qty: 2, unit: 'cups', perDay: 2 } },
    ...
    ioil:      { units: ['apps', 'ml'],     default: { qty: 1,   unit: 'apps',     perDay: 2 } },
};
