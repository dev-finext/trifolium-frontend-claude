    ...
    <div>
        ...
        <div class="input-wrap">
            ...
            <button
                ...
                class="pw-eye absolute left-[8px] top-[50%] translate-y-[-50%] inline-flex items-center justify-center p-[4px] text-ink-3 bg-transparent border-none cursor-pointer"
                @click="show = !show"
