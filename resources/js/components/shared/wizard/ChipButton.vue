...
import { CHIP_TONE } from '@/components/shared/wizard/step3-data';
...
<template>
    <button
        ...
        :title="title"
        :aria-label="title"
        class="inline-flex h-[24px] w-[24px] shrink-0 cursor-pointer items-center justify-center rounded-[50%] border-none p-0 transition-[filter,transform] duration-[140ms]"
        :class="
            hover
                ? '[transform:translateY(-1px)] brightness-[0.96]'
