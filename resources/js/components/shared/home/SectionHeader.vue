...
<template>
    <div
        class="mb-[20px] flex items-end justify-between border-b border-b-line pb-[16px]"
    >
        <div>
            <h2
                class="m-0 text-[22px] font-semibold tracking-[-0.01em] text-ink"
            >
                {{ title }}
            </h2>
            <p v-if="subtitle" class="small muted mx-0 mt-[4px] mb-0">
                {{ subtitle }}
            </p>
        </div>
        <a
