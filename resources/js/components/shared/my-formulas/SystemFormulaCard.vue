    ...
    <div class="card sf-card">
        ...
        <div class="sf-card__emblem" aria-hidden="true">
            <Icon
                ...
                :stroke="1.6"
            />
            <span class="sf-card__emblem-count"
        ...
        <div class="sf-card__side">
            <button
                class="btn btn--sm sf-card__load"
                type="button"
                @click="emit('load')"
            >
