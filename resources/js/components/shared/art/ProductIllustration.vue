...
const kind = computed(() => {
    if (props.heb.includes('כמוסות')) {
        return 'capsules';
    }

    if (
        props.heb.includes('משחת') ||
        props.heb.includes('קרם') ||
        props.heb.includes('ג׳ל')
    ) {
        return 'jar';
    }

    if (props.heb.includes('תה') || props.heb.includes('חליטה')) {
        return 'tea';
    }

    if (props.heb.includes('אבקה')) {
        return 'powder';
    }
...
<template>
    ...
    >
        ...
        <g v-if="kind === 'bottle'" transform="translate(160,98)">
            ...
            />
            <path
                d="M -10 -50 L -10 -32 L -28 6 L -28 60 Q -28 70 -16 70 L 16 70 Q 28 70 28 60 L 28 6 L 10 -32 L 10 -50 Z"
                :fill="palette.ink"
                opacity="0.92"
            />
        ...
        <g v-if="kind === 'tea'">
            ...
            <g transform="translate(160,110)">
                ...
                />
                <path
                    d="M -50 -10 L 50 -10 L 44 32 Q 40 40 30 40 L -30 40 Q -40 40 -44 32 Z"
                    :fill="palette.ink"
                    opacity="0.92"
                />
                ...
                />
                <path
                    d="M 50 0 Q 70 4 70 18 Q 70 30 54 30"
                    fill="none"
                    :stroke="palette.ink"
                    stroke-width="3"
                />
        ...
        <g v-if="kind === 'powder'" transform="translate(160,108)">
            ...
            <path
                d="M -50 -42 L 50 -42 L 38 48 Q 36 58 28 58 L -28 58 Q -36 58 -38 48 Z"
                :fill="palette.ink"
                opacity="0.92"
            />
