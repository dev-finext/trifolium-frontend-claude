...
<template>
    <div
        class="price-rail flex w-[210px] shrink-0 flex-col gap-[14px] border-e border-line px-[22px] py-[22px]"
    >
        <div>
        ...
        <div class="flex flex-wrap gap-[8px]">
            ...
            <button
                class="btn btn--ghost btn--sm flex-1 border-line text-danger"
                @click="emit('remove')"
            >
        ...
        <button
            ...
            @click="emit('hold')"
        >
            <Icon name="clock" :size="13" color="var(--ink-3)" /> העבר להזמנות
            בהמתנה
        </button>
    </div>
</template>
